...
exports.start = function(cliOptions) {
  ...
  var browserGone = function() {

    console.log('browser gone!', pendingCount)
    pendingCount--;
  ...
  globalEmitter.on('browser_failure', browserGone);
  globalEmitter.on('browser_complete', browserGone);
